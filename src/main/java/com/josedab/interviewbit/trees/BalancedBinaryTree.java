...
public class BalancedBinaryTree {
    ...
    public static void main(String []args){
        ...
        System.out.println(solution.isBalanced(TreeNodeUtils.createTreeNodeListFromInOrderSequence(1, 2,3)));
        System.out.println(solution.isBalanced(TreeNodeUtils.createTreeNodeListFromInOrderSequence(3, 2, -1, 1, -1)));
